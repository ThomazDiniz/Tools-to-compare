system "Bazooca", {
    ...
    usecase "Administrador Edita Terminal", {
        ...
        basicFlow {
            ...
            step 6, system,         "notifica usuario de que Terminal foi atualizado com sucesso", ef:[1]
        }
        ...
        postCondition "O Terminal foi atualizado com sucesso."
    }
}
