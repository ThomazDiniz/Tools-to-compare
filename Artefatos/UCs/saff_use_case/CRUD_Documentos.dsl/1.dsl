system "SAFF", {
    usecase "CRUD Documents", {
        ...
        version "1.1", type:"Modification", user:"Larissa", date:"01/02/2016"
        ...
        basicFlow {
            ...
            step 7, usuário, "preenche corretamente os campos 'Title', 'Description', 'Family', seleciona um arquivo PDF e pressiona o botão 'Create' ", af:[1,2,6,7]
            step 8, system, "exibe lista de documentos"
            step 9, usuário, "clica no ícone link de visualização do documento"
            ...
            step 17, usuário, "abre lista de extrações e seleciona uma extração das famílias cadastradas anteriormente"
