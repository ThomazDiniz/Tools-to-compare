system "SAFF Extractor", {
	usecase "Settings", {
        ...
        basicFlow {
            step 1, administrador, "pressiona botão 'Settings'"
            step 2, system, "exibe a janela de configurações"
            step 3, administrador, "seleciona a opção 'Português' no campo 'Language' e pressiona botão 'Save'", af:[1,2,3]
        ...
        alternative 1, "Linguagem Espanhol", {
            step 1, administrador, "seleciona a opção 'Español' no campo 'Language' e pressiona botão 'Save'" 
