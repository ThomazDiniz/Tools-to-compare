system "Bazooca", {
	...
	usecase "Administrador Registra Ocorrencia Em Coleta", {
		...
		basicFlow {
			...
			step 5, Administrador, 	"seleciona alguma Coleta da lista", af:[5,6,7]
			step 6, system, 		"exibe os dados da Coleta"
			step 7, Administrador, 	"clica no botao de 'Registrar Ocorrencia' para coleta inteira", af:[9]
		...
		postCondition "A ocorrencia esta registrada para todas as notas da coleta"
