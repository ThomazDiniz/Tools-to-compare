system "Bazooca", {
    ...
    usecase "Administrador Edita Administrador", {
        ...
        basicFlow {
            ...
            step 5, Administrador,  "clica no botao 'Adicionar Administrador'", af:[1,3,4,5]
        ...
        alternative 3, "Navega em lista de Administradores", {
            step 1, Administrador, "clica no botao de paginacao", bfs:4
        }

        alternative 4, "Filtra lista de Administradores", {
            step 1, Administrador, "filtra lista de Administradores por algum campo", bfs:4
        }

        alternative 5, "Ordena lista de Administradores", {
            step 1, Administrador, "ordena lista de Administradores por algum campo", bfs:4
        }        
