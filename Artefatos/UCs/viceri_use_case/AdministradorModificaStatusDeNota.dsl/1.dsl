system "Bazooca", {
	...
	usecase "Administrador Modifica Status De Nota", {
		...
		basicFlow {
			...
			step 7,  Administrador, 	"clica no botao de 'Alterar Status'", af:[11]
			step 8,  system, 			"abre drop list para selecao de novo Status"
			step 9,  Administrador,  	"seleciona novo Status e clica em 'Alterar'", af:[9]
			step 10, system, 			"notifica que Status da Nota foi alterado com sucesso"
		}
		...
		alternative 9, "Cancela alteracao de Status", {
			step 1, Administrador, "clica em botao 'Cancelar' de drop list", bfs:6
		}

		alternative 10, "Filtra notas da lista", {
			step 1, Administrador, "filtra os notas por algum campo", bfs:4
		}
