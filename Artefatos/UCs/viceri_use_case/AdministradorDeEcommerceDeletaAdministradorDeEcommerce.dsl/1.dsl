system "Bazooca", {
    ...
    usecase "Administrador De Ecommerce Deleta Administrador De Ecommerce", {
        ...
        preCondition "Usuario esta logado no sistema. Existe mais de um usuario Administrador no Ecommerce alvo"
        ...
        basicFlow {
            ...
            step 5,  AdminEcommerce,  "clica em botao 'Excluir' de algum dos Administradores de Ecommerce listados", af:[2]
            step 6,  system,          "exibe popup pedindo Confirmacao de delecao"
            step 7,  AdminEcommerce,  "confirma delecao", af:[3]
            step 8,  system,          "notifica que o Administrador de Ecommerce foi excluido com sucesso"
        }
        ...
        alternative 2, "Cancela delecao de Administrador de Ecommerce", {
