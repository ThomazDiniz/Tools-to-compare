system "Bazooca", {
	...
	usecase "Operador De Terminal Adiciona Beneficio Ao Terminal", {
		...
		basicFlow {
			...
			step 5, Operador, 	"clica eno botao 'Adicionar Beneficio'", af:[2]
			step 6, system, 	"exibe form de adicao de dados de Beneficio"
			step 7, Operador, 	"clica no botao de 'Adicionar' do form de adicao de Beneficio", af:[1]
			step 8, system, 	"notifica que o Beneficio de Terminal foi inserido com sucesso", ef:[1,2]
		}

		alternative 1, "cancela insercao de Beneficio de Terminal", {
			step 1, Operador, "clica em botao 'Cancelar' de form de dados de Beneficio", bfs:4
		}
