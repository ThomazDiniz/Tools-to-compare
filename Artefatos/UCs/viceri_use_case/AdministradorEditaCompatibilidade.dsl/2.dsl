system "Bazooca", {
	...
	usecase "Administrador Edita Compatibilidade", {
		...
		basicFlow {
			...
			step 3, Administrador, "clica em uma Compatibilidade existente'", af:[1,2,3]
		...
		alternative 1, "Usuario ordena lista de Compatibilidades",  {
			step 1, Administrador, "clica em um dos botões de ordenacao associada a uma coluna da tabela", bfs:2
		}

		alternative 2, "Usuario filtra lista de Compatibilidades", {
		...
		alternative 4, "Usuario cancela atualizacao de Compatibilidade", {
