system "Bazooca", {
    ...
    usecase "Administrador Edita Operador De Ecommerce", {
        ...
        basicFlow {
            step 1, Administrador,  "seleciona a opcao 'Ecommerces' no menu da tela principal" 
            step 2, system,         "mostra a lista de Ecommerces do sistema"
            step 3, Administrador,  "seleciona o E-commerce do operador", af:[1,2,3,5]
        ...
        alternative 2, "Ordena lista de Ecommerce", { 
        ...
        alternative 5, "Filtra lista de Ecommerce", {
            step 1, Administrador, "filtra lista de Ecommerce por algum campo", bfs:4
        }
